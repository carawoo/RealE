    ...
    <section className="page-container">
      <article className="surface privacy-surface">
        ...
        <section className="privacy-section">
          ...
          <ul>
            <li>회원 가입 시: 이메일 주소, 비밀번호, 닉네임</li>
            <li>소셜 로그인(Google, Kakao) 시: 공급자가 제공하는 고유 식별자, 이메일, 프로필 정보</li>
            <li>상담 이용 시: 채팅 내용, 상담 히스토리, 상담 공유를 위한 식별 정보</li>
            <li>기타: 서비스 이용 과정에서 자동 생성되는 접속 로그, 쿠키, 기기 정보</li>
          </ul>
        </section>
