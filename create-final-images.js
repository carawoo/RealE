...
// 메인 실행 함수
async function createFinalImages() {
  console.log('🎨 최종 블로그 이미지 생성 시작...\n');
...
<body>
    ...
    <div class="description">${imageInfo.description}</div>
</body>
</html>`;
}
...
if (require.main === module) {
  createFinalImages().catch(console.error);
}

module.exports = { blogImages, createFinalImages };
