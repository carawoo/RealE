...
3. 무주택자 정**씨 (연소득 4천만원)
   ...
   - "정책자금과 청약저축을 함께 활용했다"`,
    ...
    '신생아': `실제 사례들:
1. 신생아 가정 강**씨 (2023년 출생, 연소득 1억원)
   - 신생아 특례대출 신청
   - 7억 아파트 구입, 신생아 특례대출 5.6억 승인
   - "출산 후 6개월 내에 신청해야 했다"

2. 신생아 가정 한**씨 (2024년 출생, 연소득 8천만원)
   - 신생아 특례 + 디딤돌대출 조합
   - 5억 아파트 구입, 총 대출 4억 승인
   - "신생아 특례가 더 유리해서 선택했다"`,

    '다자녀': `실제 사례들:
1. 2자녀 가정 조**씨 (연소득 9천만원)
   - 다자녀 특례대출 신청
   - 6억 아파트 구입, 다자녀 특례대출 4.8억 승인
   - "자녀 2명 이상이어서 특례 혜택을 받았다"

2. 3자녀 가정 윤**씨 (연소득 1억원)
   - 다자녀 특례 + 보금자리론 조합
   - 8억 아파트 구입, 총 대출 6.4억 승인
   - "자녀 수가 많을수록 더 유리했다"`,

    '대출': `실제 사례들:
1. 대출 거절 후 재신청 성공 송**씨
   - 첫 신청: 신용등급 7등급으로 거절
